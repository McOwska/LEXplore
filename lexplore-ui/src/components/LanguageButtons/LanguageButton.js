...
const LanguageButton = ({ languageCode }) => {
    ...
    return (
        <img className={`${styles.languageButton} ${translationLanguage === languageCode.split('_')[0] ? styles.languageButtonActive : styles.languageButtonInactive}`} onClick={changeLanguage} src={imgPath} alt={languageCode}/>
    );
}
